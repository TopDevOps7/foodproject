        ...
        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
            <div class="card bg-success img-card box-success-shadow x-box-cards">
                <div class="card-body card-taps">
                    <a href="{{ route('dashboard_advertisement.index') }}"></a>
                    <div class="d-flex">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_topprojects.index') }}" style="text-decoration: none;color: #000">
                        ...
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_topprojects.index') }}">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_topprojects.index', ['status' => 3]) }}" style="text-decoration: none;color: #000">
                        ...
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_topprojects.index', ['status' => 3]) }}">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_topprojects.index', ['status' => 5]) }}" style="text-decoration: none;color: #000">
                        ...
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_topprojects.index', ['status' => 5]) }}">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_topprojects.index', ['status' => 1]) }}" style="text-decoration: none;color: #000">
                        ...
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_topprojects.index', ['status' => 1]) }}">
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <form method="post" action="{{ route('dashboard_advertisement.export') }}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('dashboard_advertisement.get_data') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
