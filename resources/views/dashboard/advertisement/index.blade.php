...
@section('create_btn'){{route('dashboard_advertisement.add_edit')}}@endsection
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <select class="form-control ajax_cat select2-show-search">
                                        <optgroup label="Choose Advertisement">
        ...
        $(document).ready(function () {
            ...
            //   console.log(e.target.value, $(this).data('id'));
               ...
               var priority = e.target.value;
                $.ajax({
                    url: "{{ route('dashboard_advertisement.priority') }}",
                    method: "get",
                    data: {
                        id,
                        priority,
            ...
            $(document).on('click', '.btn_featured', function () {
                ...
                $.ajax({
                    url: "{{ route('dashboard_advertisement.featured') }}",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $('.btn_deleted').on("click", function () {
                var id = $('#iddel').val();
                $.ajax({
                    url: "{{ route('dashboard_advertisement.deleted') }}",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $(document).on('click', '.ajax_delete_all', function () {
                $.ajax({
                    url: "{{ route('dashboard_advertisement.deleted_all') }}",
                    method: "get",
                    data: {
                        "array": array,
                    },
